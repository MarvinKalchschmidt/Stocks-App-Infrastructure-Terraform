...
module "web-server" {
  ...
  python_server_url           = module.python-server.python_server_url
  depends_on                  = [module.cluster, module.mongodb, module.python-server]
}
...
module "next-frontend" {
  ...
  port_protocol          = var.port_protocol
  image_pull_policy      = var.image_pull_policy
  web_server_url         = module.web-server.web_server_url
  depends_on             = [module.cluster, module.web-server]
}
